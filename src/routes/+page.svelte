...
<article
	class="items-center justify-center align-middle h-full min-h-[70vh] lg:min-h-[81.3vh] gap-8"
>
	<h1 class="h1 capitalize">Hey, I'm Amjad <br /> but you can call me the Front-End Wizard!</h1>
